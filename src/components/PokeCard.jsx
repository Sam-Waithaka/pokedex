...
export default function PokeCard(props){
    ...
    async function fetchMoveData(move, moveUrl){
        ...
        if (move in c){
            setSkill(c[move])
            console.log(`Found move ${move} in cache`);
            return
        }
    ...
    useEffect(()=>{
        ...
        // 2. check if the selected pokeon is in the cache, otherwise fetch from the API 
        if (selectedPokemon in cache){
            // Read from cache
            setData(cache[selectedPokemon])
            console.log(`found pokemon ${selectedPokemon} in cache`);
        ...
        async function fetchPokemonData(){
            ...
            try{
                ...
                setData(pokemonData);
                console.log(`Fetched pokemon ${pokemonData} data`);
